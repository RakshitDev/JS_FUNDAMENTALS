...
// How the the spread operator work
// ->Spread usually expand all element  from an array or the objecct
let author = books[0].author;
let allAuthors = ["Ramesh", "suresh", "mahesh", ...author];
console.log(...allAuthors); //op ->Ramesh suresh mahesh Robert Sedgewick Kevin Wayne values are unpacked from the array here

[one, two, three, ...author] = allAuthors; // Ramesh suresh mahesh
console.log("recentlyJoined:", one, two, three);
console.log("Old Author", author); //['Robert Sedgewick', 'Kevin Wayne'] see here it packed them iside the array

// note always user rest pattern as the last element inside the array
//rest pattern is always used on the lhs side of the assigment operator and spread operator on the rhs side of the assigment operate
...
// Rest as the function parameter
function add(...numbers) {
  // see here number it catches every argument and catch them inside the array  and that i am using to calculate the sum
  let sum = 0;
