const books = [
  {
    ...
    highlighted: true,
    printBookInfo: function ({ title, author, year }) {
...
const { title, author, ISBN } = books[1];
...
// notedestructung  of ibject  is read only you cannot add proprtyies to object or array
...
let printBookInfo = function ({ title, author, year = "unknown" }) {
  console.log(`${title} by ${author}, ${year}`);
};
